        ...
        OpenSearchAccess: new iam.PolicyDocument({
          statements: [
            new iam.PolicyStatement({
              ...
              actions: [
                'aoss:APIAccessAll', // Required: data plane access for opensearch-py client
              ],
              resources: [
      ...
      policy: JSON.stringify([
        {
          ...
          // Required: Bedrock Knowledge Base needs public network access to reach the collection.
          // Access is still controlled by the data access policy (IAM principal-based).
